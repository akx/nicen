...
const NICEN_NATIVE_HOST = process.env.NICEN_NATIVE_HOST || NICEN_HOST;
const NICEN_NATIVE_PORT = parseInt(process.env.NICEN_NATIVE_PORT || '62090', 10);
const NICEN_NATIVE_URL = `http://${NICEN_NATIVE_HOST}:${NICEN_NATIVE_PORT}/`;
